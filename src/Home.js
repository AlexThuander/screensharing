		...
		return (
			<div className="container2">
				...
				<div style={{ marginTop: "64px" }}>
					<h1 style={{ fontSize: "45px" }}>Screen Sharing</h1>
					<p style={{ fontWeight: "200" }}>Your screen will be shared on https://binaryrenko.com/creative-investment-model</p>
				</div>
				...
				<div style={{
					...
					<p style={{ margin: 0, fontWeight: "bold", paddingRight: "50px" }}>Start sharing your screen</p>
